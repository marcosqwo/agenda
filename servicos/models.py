...
class Servico(models.Model):
    ...
    preco = models.DecimalField('Preço',decimal_places=2, max_digits=5,help_text='Preço do serviço')
...
class ProdutosServico(models.Model):
    ...
    produto = models.ForeignKey('produtos.Produto', verbose_name='Produto',help_text='Nome do produto ultilizado',on_delete=models.PROTECT,related_name='produto')
