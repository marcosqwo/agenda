...
class Agendamento(models.Model):
    ...
    servico = models.ManyToManyField('servicos.Servico',verbose_name='Serviços',through='agendamentos.OrdemServicos')

    valor = models.DecimalField('Valor total',max_digits=6,decimal_places=2,default=0.00)
    status = models.CharField('Status',max_length=1,default='A',help_text='Status do agendamento')
...
class OrdemServicos(models.Model):
    ...
    funcionario = models.ForeignKey('funcionarios.Funcionario', verbose_name='Funcionário',
                                    related_name='funcionario', on_delete=models.PROTECT)
